import keras
from keras.layers import Input,Conv2D,MaxPooling2D,UpSampling2D, ReLU, BatchNormalization, Dense, Dropout, ZeroPadding2D, Cropping2D
...
def ConvAutoEnc(input):
    ...
    pool_layer1 = MaxPooling2D(pool_size=(2, 2))(relu_layer1)
    ...
    pool_layer2 = MaxPooling2D(pool_size=(2, 2))(relu_layer2)
    ...
    zerop_layer1 = ZeroPadding2D(padding=(2,0))(relu_layer3)
    pool_layer3 = MaxPooling2D(pool_size=(3,3))(zerop_layer1)
    
 
 
  #fully-conected part
    dropout_layer1 = Dropout(rate=0.5, noise_shape=None, seed=None)(pool_layer3)
	...
	# --
    dense_layer6 = Dense(168, activation=None, use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros', kernel_regularizer=None, bias_regularizer=None, activity_regularizer=None, kernel_constraint=None, bias_constraint=None)(dense_layer3)
    d_dropout_layer2 = Dropout(rate=0.5, noise_shape=None, seed=None)(dense_layer6)
    dense_layer7 = Dense(504, activation=None, use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros', kernel_regularizer=None, bias_regularizer=None, activity_regularizer=None, kernel_constraint=None, bias_constraint=None)(d_dropout_layer2)
    d_dropout_layer3 = Dropout(rate=0.5, noise_shape=None, seed=None)(dense_layer7)
    dense_layer8 = Dense(2016, activation=None, use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros', kernel_regularizer=None, bias_regularizer=None, activity_regularizer=None, kernel_constraint=None, bias_constraint=None)(d_dropout_layer3)
    d_dropout_layer4 = Dropout(rate=0.5, noise_shape=None, seed=None)(dense_layer8)
    
    
    #decoder part
    unpool_layer1 = UpSampling2D((3,3))(d_dropout_layer4)
    cropping_layer1 = Cropping2D(cropping=(2,0))(unpool_layer1)
    d_relu_layer1 = ReLU(max_value=None, negative_slope=0, threshold=0.0)(cropping_layer1)
    deconv_layer1 = Conv2D(32,[3,3], activation = 'relu', padding = 'same')(d_relu_layer1)
    unpool_layer2 = UpSampling2D((2,2))(deconv_layer1)
    ...
    d_relu_layer2 = ReLU(max_value=None, negative_slope=0, threshold=0.0)(unpool_layer2)
    deconv_layer2 = Conv2D(64,[3,3], activation = 'relu', padding = 'same')(d_relu_layer2)
    unpool_layer3 = UpSampling2D((2,2))(deconv_layer2)
    ...
    d_relu_layer3 = ReLU(max_value=None, negative_slope=0, threshold=0.0)(unpool_layer3)
